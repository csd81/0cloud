...
A számítástechnika Szent Grálja egy olyan rendszer, amely kivételesen nagy teljesítményű, ingyenes vagy nagyon olcsó a használata, bárki számára hozzáférhető, megbízható és mindenütt jelenlévő, gyors, hatékony és egyszerű módot biztosít az alkalmazásfejlesztésre és üzembe helyezésre, és ugyanakkor maximális felhasználói élményt és használhatóságot nyújt a végfelhasználók számára. Ezt a varázslatos rendszert még nem találtuk meg, de a felhő valószínűleg a létező jelöltek közül a legközelebb áll hozzá.
...
![2-5. ábra: A Cray-1 szuperszámítógép](<../Cloud Programming_MSc_Juhasz_IId-13_1.png>)

![2-6. ábra: A Tianhe-2 szuperszámítógép](<../Cloud Programming_MSc_Juhasz_IId-13_2.png>)

![2-7. ábra: A Summit szuperszámítógép](<../Cloud Programming_MSc_Juhasz_IId-13_3.png>)

![2-8. ábra: A Fugaku szuperszámítógép](<../Cloud Programming_MSc_Juhasz_IId-13_4.png>)
...
int main(){
  ...
  /*---- A socket létrehozása. A három argumentum a következő: ----*/
  /* 1) Internet-domain 2) Stream-socket 3) Alapértelmezett protokoll (itt TCP) */
  clientSocket = socket(PF_INET, SOCK_STREAM, 0);

  /*---- A szerver címstruktúrájának beállítása ----*/
  /* Címcsalád = Internet */
  serverAddr.sin_family = AF_INET;
  /* Portszám beállítása; a htons függvény a helyes bájtsorrendhez */
  serverAddr.sin_port = htons(7891);
  /* IP-cím beállítása a helyi gépre (localhost) */
  serverAddr.sin_addr.s_addr = inet_addr("127.0.0.1");
  /* A padding mező összes bitjét 0-ra állítjuk */
  memset(serverAddr.sin_zero, '\0', sizeof serverAddr.sin_zero);

  /*---- A socket csatlakoztatása a szerverhez a címstruktúra használatával ----*/
  addr_size = sizeof serverAddr;
  connect(clientSocket, (struct sockaddr *) &serverAddr, addr_size);

  /*---- A szervertől érkező üzenet beolvasása a pufferbe ----*/
...
public class MyClient {
    ...
    public void start(){
        try {
            ...
            // 2. kommunikációs adatfolyamok létrehozása
...
![2-10. ábra: Az RPC mechanizmus megvalósítása](<../Cloud Programming_MSc_Juhasz_IId-16_1.png>)
...
![2-11. ábra: A Java RMI rendszer összetevői és architektúrája](<../Cloud Programming_MSc_Juhasz_IId-18_1.png>)
...
![2-13. ábra: Egy szolgáltatásorientált rendszer általános architektúrája és működése](<../Cloud Programming_MSc_Juhasz_IId-21_1.png>)
...
![2-14. ábra: A Web Service architektúra](<../Cloud Programming_MSc_Juhasz_IId-22_1.png>)
...
![2-15. ábra: A Web Service technológiai stack](<../Cloud Programming_MSc_Juhasz_IId-22_2.png>)
...
![2-17. ábra: A Globus erőforrás-menedzsment rendszerének architektúrája](<../Cloud Programming_MSc_Juhasz_IId-25_1.png>)
...
![2-19. ábra: A SUN Grid konténer](<../Cloud Programming_MSc_Juhasz_IId-27_1.png>)
...
![2-20. ábra: A virtualizáció lehetővé teszi különböző operációs rendszerek futtatását ugyanazon a hardveren](<../Cloud Programming_MSc_Juhasz_IId-28_1.png>)
...
![2-21. ábra: Az erőforrás-virtualizáció különböző formái¹⁰](<../Cloud Programming_MSc_Juhasz_IId-28_2.png>)

A teljes és paravirtualizációs módszerek szoftveralapú megközelítések. Az utasításokat binárisan lefordítják a vendégváltozatról a gazdagépen futó változatra, ami jelentős teljesítményveszteséget okoz. A hardvervirtualizáció legelterjedtebb stratégiája ma a *hardveresen támogatott virtualizáció* (*hardware-assisted virtualisation*), amely a CPU-gyártók speciális hardvertámogatására támaszkodik. Ebben a módban az operációs rendszer vagy alkalmazás számos funkciója felhasználhatja a gazdagép számítógép (főleg a CPU-jának) fizikai hardver-erőforrásait, ami sokkal magasabb teljesítményt eredményez, mint a teljes szoftver-emuláció alapú virtualizációs technikák.
...
![3-3. ábra: Menedzsmentfelelősségek változása a felhő különböző absztrakciós rétegeiben](<../Cloud Programming_MSc_Juhasz_IId-32_1.png>)
...
![3-4. ábra: A Google egyik felhő-adatközpontja](<../Cloud Programming_MSc_Juhasz_IId-32_2.png>)

![3-5. ábra: Az Amazon egyik felhő-adatközpontja](<../Cloud Programming_MSc_Juhasz_IId-33_1.png>)

![3-6. ábra: Egy Amazon adatközpont belseje](<../Cloud Programming_MSc_Juhasz_IId-33_2.png>)

![3-7. ábra: Egy Google adatközpont belseje](<../Cloud Programming_MSc_Juhasz_IId-33_3.png>)

![3-8. ábra: A Google adatközpont hűtőrendszerének gépháza](<../Cloud Programming_MSc_Juhasz_IId-34_1.png>)
...
![3-9. ábra: Általános felhőtechnológiai stack. Megjegyzendő, hogy a szolgáltatások (IaaS, PaaS, SaaS) a felhasználó felé fordított felületet képviselik](<../Cloud Programming_MSc_Juhasz_IId-34_2.png>)
...
![3-10. ábra: Egy felhőplatform különböző felhasználói közösségeket célzó szolgáltatásai](<../Cloud Programming_MSc_Juhasz_IId-35_1.png>)
...
![3-11. ábra: A globális felhőszolgáltatók piaci részesedésének és éves növekedési rátájának pozíciója](<../Cloud Programming_MSc_Juhasz_IId-36_1.png>)
...
![3-12. ábra (d): A felhőszolgáltatók elhelyezkedésének alakulása a Gartner Group Challengers–Leaders–Niche Players–Visionaries mátrixában (2015–2020)](<../Cloud Programming_MSc_Juhasz_IId-37_4.png>)
...
![4-1. ábra: Szolgáltatáskategóriák az Amazon Web Servicesnél](<../Cloud Programming_MSc_Juhasz_IId-40_1.png>)
...
![4-2. ábra: Meglévő és tervezett AWS globális régiók](<../Cloud Programming_MSc_Juhasz_IId-41_1.png>)
...
| Példánytípus | vCPU | Memória (GiB) | Tároló | Dedikált EBS sávszélesség (Mbps) | Hálózati teljesítmény |
|---|---:|---:|---|---:|---|
...
![4-3. ábra: Intelligens adatrétegezés az AWS S3 szolgáltatásban](<../Cloud Programming_MSc_Juhasz_IId-43_1.png>)
...
![4-4. ábra: Privát és publikus alhálózatok, terheléselosztás és biztonsági szolgáltatások kombinációja](<../Cloud Programming_MSc_Juhasz_IId-45_1.png>)
...
![4-5. ábra: Alkalmazás-menedzsment munkafolyamata](<../Cloud Programming_MSc_Juhasz_IId-46_1.png>)
...
![5-1. ábra: A GCP adatközpontok elhelyezkedése](<../Cloud Programming_MSc_Juhasz_IId-49_1.png>)
...
![5-2. ábra: A globális, regionális és zónaszintű erőforrás-koncepció szemléltetése](<../Cloud Programming_MSc_Juhasz_IId-50_1.png>)

A GCP ma már több mint 100 terméket foglal magában; ezek egy reprezentatív részhalmazát az 5-3. ábra mutatja be.

![5-3. ábra: A Google Cloud Platform termékeinek reprezentatív részhalmaza](<../Cloud Programming_MSc_Juhasz_IId-50_2.png>)
...
![5-4. ábra: A Google Cloud Platform globális hálózati összeköttetései](<../Cloud Programming_MSc_Juhasz_IId-52_1.png>)
...
![6-1. ábra: A Google Cloud Platform Console](<../Cloud Programming_MSc_Juhasz_IId-53_1.png>)



### 6.2 A GCP erőforrások elérésének módjai
A webes konzol (GCP Console) nem az egyetlen módja a GCP-erőforrások elérésének. A szakértő DevOps mérnökök és felhőadminisztrátorok számára a legkényelmesebb és leggyorsabb eszköz a gcloud parancssori felület (Command Line Interface – CLI). A gcloud rendszerezett parancsok hierarchiáját biztosítja a különböző szolgáltatások eléréséhez és automatizálásához. Ez az eszköz a lokálisan telepíthető Google Cloud SDK részét képezi. Két egyszerű példa az alábbiakban szemlélteti a használatát:
...
![6-2. ábra: A Google Cloud Shell használata a GCP Console-ból](<../Cloud Programming_MSc_Juhasz_IId-54_1.png>)
...
![7-1. ábra: Az adatelőállítás és -tárolás analóg-digitális átalakulása az elmúlt évtizedekben](<../Cloud Programming_MSc_Juhasz_IId-58_1.png>)
...
![7-2. ábra: A stream-feldolgozás koncepciója ismeretlen méretű adathalmazon](<../Cloud Programming_MSc_Juhasz_IId-60_1.png>)
...
A Hadoop/MapReduce keretrendszer egy nyílt forráskódú Apache projekt, amelyet eredetileg a Yahoo fejlesztett ki nagyléptékű webes keresőadatok indexelésére a Google által közzétett Map-Reduce programozási modell alapján. A mögöttes infrastruktúra egy nagyméretű, olcsó, általános célú szerverekből (commodity servers) álló klaszter. Ezen fut a Hadoop, egy Java nyelven írt szoftverrendszer, amely hibatűrő és platformfüggetlen futtatási környezetet biztosít.
...
![7-3. ábra: A Hadoop architektúrája és job-végrehajtási mechanizmusa](<../Cloud Programming_MSc_Juhasz_IId-62_1.png>)
...
![7-4. ábra: A WordCount példaprogram végrehajtásának fázisai](<../Cloud Programming_MSc_Juhasz_IId-63_1.png>)
...
![7-5. ábra: A Spark gazdag támogatása harmadik féltől származó alkalmazásokhoz](<../Cloud Programming_MSc_Juhasz_IId-65_2.png>)
...
![7-6. ábra: Köztes adatkommunikáció Hadoop/MapReduce esetén](<../Cloud Programming_MSc_Juhasz_IId-65_2.png>)



![7-7. ábra: Köztes adatkommunikáció Sparkban](<../Cloud Programming_MSc_Juhasz_IId-66_1.png>)
...
![7-8. ábra: A Dataproc szolgáltatás és lehetséges kapcsolatai más szolgáltatásokhoz](<../Cloud Programming_MSc_Juhasz_IId-67_1.png>)
...
![7-9. ábra: Példa a Hadoop-klaszter monitorozó ablakára](<../Cloud Programming_MSc_Juhasz_IId-69_1.png>)
...
double varianceTwoPass(double[] data){
    ...
    // második menet: minta szórásnégyzetének számítása
    double variance = 0.0;
    for (int i = 0; i < data.length; i++) {
...
![8-2. ábra: A Spark Streaming adatkapcsolatai harmadik féltől származó forrásokhoz és nyelőkhöz](<../Cloud Programming_MSc_Juhasz_IId-76_1.png>)
...
![8-3. ábra: Stream-végrehajtás megvalósítása a Spark batch-motor tetején](<../Cloud Programming_MSc_Juhasz_IId-76_2.png>)
...
```java
...
// A streaming kontextus létrehozása 1 másodperces kötegmérettel
SparkConf sparkConf = new SparkConf().setAppName("JavaNetworkWordCount");
JavaStreamingContext ssc = new JavaStreamingContext(sparkConf, Durations.seconds(1));

// JavaReceiverInputDStream létrehozása a megadott ip:port párra; ezen
// a \n karakterrel tagolt bemeneti adatfolyam szavait olvassa be (pl. amit az 'nc' generál)
// Helyi futtatáshoz nincs replikálás a tárolási szinten.
// Elosztott környezetben a replikálás a hibatűréshez szükséges.
...
![8-4. ábra: Korlátos és korlátlan streamek egységes kezelése Flinkben](<../Cloud Programming_MSc_Juhasz_IId-77_1.png>)
...
![8-5. ábra: Gazdag integrációs funkciók gyors fejlesztést biztosítanak Flinkben](<../Cloud Programming_MSc_Juhasz_IId-77_2.png>)
...
![8-6. ábra: Állapottartó feldolgozás memóriabeli vagy lemezes állapotperzisztenciával](<../Cloud Programming_MSc_Juhasz_IId-78_1.png>)
...
![8-7. ábra: Spoutokból és Boltokból álló Storm-topológia](<../Cloud Programming_MSc_Juhasz_IId-79_1.png>)



![8-8. ábra: A Storm klaszter-architektúra](<../Cloud Programming_MSc_Juhasz_IId-79_2.png>)



![8-9. ábra: Feldolgozási topológia a Storm Word Count példához](<../Cloud Programming_MSc_Juhasz_IId-80_1.png>)
...
![8-10. ábra: A Kafka helye egy stream-feldolgozó alkalmazáson belül](<../Cloud Programming_MSc_Juhasz_IId-83_1.png>)



![8-11. ábra: Topic-partíció megvalósítása várakozási soron (queue)](<../Cloud Programming_MSc_Juhasz_IId-83_2.png>)



![8-12. ábra: A topic hibatűrésének belső részletei partíció-replikáció alapján egy klaszterben](<../Cloud Programming_MSc_Juhasz_IId-84_1.png>)
...
![8-13. ábra: A Google Dataflow és a Beam SDK integrációja a GCP szolgáltatás-architektúrájában](<../Cloud Programming_MSc_Juhasz_IId-86_1.png>)
...
![8-14. ábra: Egyszerű Beam-pipeline három transzformációval](<../Cloud Programming_MSc_Juhasz_IId-86_2.png>)
...
![8-15. ábra: Néhány szemléltető adatfolyam-feldolgozó keretrendszer összehasonlítása](<../Cloud Programming_MSc_Juhasz_IId-90_1.png>)
 ...
 * HTTP Cloud Function.
 *
 * @param {Object} req a felhőfüggvény kérés-kontextusa.
 * More info: https://expressjs.com/en/api.html#req
 * @param {Object} res a felhőfüggvény válasz-kontextusa.
...
![9-1. ábra: A Cloud Functions áttekintő oldala a Google Cloud Console-ban](<../Cloud Programming_MSc_Juhasz_IId-94_1.png>)

![9-2. ábra: A függvény tesztelése a Google Cloud Console felületén](<../Cloud Programming_MSc_Juhasz_IId-95_1.png>)
...
![9-3. ábra: A Cloud Functions naplóablaka a Google Cloud Console-ban](<../Cloud Programming_MSc_Juhasz_IId-95_2.png>)
...
![10-1. ábra: Google Pub/Sub támogatás a Google szolgáltatásokban](<../Cloud Programming_MSc_Juhasz_IId-97_1.png>)

![10-2. ábra: Lehetséges szolgáltatás-összekapcsolások a Pub/Sub-ban](<../Cloud Programming_MSc_Juhasz_IId-97_2.png>)
...
![10-3. ábra: Sok-az-egyhez és egy-a-sokhoz közzétevő-feliratkozó kapcsolatok szemléltetése](<../Cloud Programming_MSc_Juhasz_IId-98_1.png>)
...
![10-4. ábra: Üzenet feldolgozásának lépései a Pub/Sub-ban](<../Cloud Programming_MSc_Juhasz_IId-99_1.png>)
...
public class PublishWithErrorHandlerExample {
  ...
  public static void main(String... args) throws Exception {
    // TODO: futtatás előtt cseréld ki ezeket a változókat!
    String projectId = "your-project-id";
...
![10-5. ábra: A Pull üzenetkézbesítés szekvenciadiagramja](<../Cloud Programming_MSc_Juhasz_IId-102_1.png>)

![10-6. ábra: A Push üzenetkézbesítés szekvenciadiagramja](<../Cloud Programming_MSc_Juhasz_IId-102_2.png>)
...
| Szolgáltatás | Leírás |
|---|---|
| AutoML | Olyan szolgáltatáscsalád, amely lehetővé teszi egyedi gépi tanulási (ML) modellek létrehozását a Google fejlett technológiáira építve. Különböző területeken alkalmazható, mint például szövegfeldolgozás (AutoML Natural Language), képosztályozás és objektumfelismerés (AutoML Vision), videóelemzés és objektumkövetés (AutoML Video Intelligence), valamint strukturált adatok elemzése (AutoML Tables). |
| Vision AI | Képfelismerési és elemzési funkciókat biztosító szolgáltatás, amely előre tanított vagy egyedi modelleket használ. Képes szöveg kinyerésére és felismerésére (OCR), képcímkézésre, arc- és nevezetesség-felismerésre, valamint tartalommoderálásra. |
| Video AI | Videószekvenciákban tesz lehetővé hatékony tartalomfelfedezést, objektumkövetést és snittekre (shot) bontott elemzést. |
| Cloud Natural Language | Természetes nyelvfeldolgozó technológia, amely hangulatelemzést (sentiment analysis), entitásfelismerést, tartalomosztályozást és szintaktikai elemzést kínál strukturálatlan szövegek mélyebb megértéséhez. |
| Cloud Translation | Dinamikus fordítást tesz lehetővé tetszőleges nyelvpárok között, megnyitva az alkalmazásokat és weboldalakat a globális piac előtt. |
| Text-to-Speech | Szöveges bemenetet vagy SSML (Speech Synthesis Markup Language) adatot alakít át természetes hangzású beszéddé. |
| Speech-to-Text | Lehetővé teszi a Google beszédfelismerési technológiáinak egyszerű integrálását: a beküldött audio fájlokból szöveges átiratot készít. |
| Dialogflow | Intelligens beszélgető ágensekre (chatbotokra) épülő, hang- és szövegalapú párbeszédes felületek létrehozását támogató platform. |
...
A rendszer számos egyéb detektálási módot is támogat. A teljes lista: `TEXT_DETECTION` (szövegfelismerés), `DOCUMENT_TEXT_DETECTION` (kézzel írt vagy dokumentumszöveg), `FACE_DETECTION` (arcfelismerés), `LANDMARK_DETECTION` (nevezetességek), `LOGO_DETECTION` (logók), `LABEL_DETECTION` (képcímkézés), `SAFE_SEARCH_DETECTION` (nemkívánatos tartalmak szűrése), `CROP_HINTS` (vágási javaslatok), `IMAGE_PROPERTIES` (a kép domináns színei), `OBJECT_LOCALIZATION` (objektumok lokalizálása) és `PRODUCT_SEARCH` (termékkeresés). Amennyiben egyszerre több dolgot (például szöveget, kézzel írt szöveget és logókat) is szeretnénk felismerni ugyanazon a képen, több jellemzőt is hozzáadhatunk a kéréshez, ahogy az alábbi kódrészlet mutatja:
...
A fordítás paraméterezhető is: explicit módon megadhatjuk a forrás- és a célnyelvet, valamint kiválaszthatjuk a használni kívánt modellt is. Az alábbi példa a forrásnyelvet spanyolra, a célnyelvet németre, a használandó modellt pedig a prémium, neurális gépi fordításra (`nmt`) állítja be:
...
Translation translation =
    translate.translate(
        ...
        // A "base" az alap, az "nmt" a neurális (prémium) fordítási modellt választja.
...
/**
 * Google Cloud TextToSpeech API mintaalkalmazás. Futtatás: mvn package exec:java
 *  -Dexec.mainClass='com.example.texttospeech.QuickstartSample'
 */
public class QuickstartSample {

  /** A Text-to-Speech API használatát mutatja be. */
  public static void main(String... args) throws Exception {
    // Kliens példányosítása
    try (TextToSpeechClient textToSpeechClient = TextToSpeechClient.create()) {
      // A szintetizálandó bemeneti szöveg beállítása
      SynthesisInput input = SynthesisInput.newBuilder().setText(
                              "Hello, World!").build();

      // A hangkérés összeállítása: nyelvkód ("en-US") és
      // az SSML hangnem
      // ("neutral") beállítása
      ...
      // A visszakapott audiofájl típusának kiválasztása
      AudioConfig audioConfig =
          AudioConfig.newBuilder().setAudioEncoding(AudioEncoding.MP3).build();

      // A szövegfelolvasási kérés végrehajtása a megadott bemenetre,
      // a választott hangparaméterekkel és
      // audiofájl-típussal
      SynthesizeSpeechResponse response =
          textToSpeechClient.synthesizeSpeech(input, voice, audioConfig);

      // Az audiotartalom kinyerése a válaszból
      ByteString audioContents = response.getAudioContent();

      // A válasz kiírása a kimeneti fájlba.
...
![12-1. ábra: Komplex OCR alkalmazás munkafolyamata és architektúrája](<../Cloud Programming_MSc_Juhasz_IId-110_1.png>)
...
public class OcrProcessImage implements BackgroundFunction<GcsEvent> {
  // TODO: állítsd be ezeket a környezeti változókat
  ...
  private void detectText(String bucket, String filename) {
    ...
    // Szöveg felismerése a képen a Cloud Vision API használatával
    ...
    try (ImageAnnotatorClient client = ImageAnnotatorClient.create()) {
      ...
      // Hiba naplózása (mivel a Cloud Function nem dobhat IOException-t)
    ...
    // Nyelv felismerése a Cloud Translation API használatával
    ...
    try (TranslationServiceClient client = TranslationServiceClient.create()) {
      ...
      // Hiba naplózása (a függvény nem dobhat IOException-t)
    ...
    // Pub/Sub fordítási kérés küldése minden célnyelvre
...
public class OcrTranslateText implements BackgroundFunction<PubSubMessage> {
  ...
  public void accept(PubSubMessage pubSubMessage, Context context) {
    ...
    // A lefordított szöveg továbbítása a következő Pub/Sub témakörbe
    ...
    try {
      ...
      // Hiba naplózása (a függvény nem dobhatja ezeket a kivételtípusokat)
      logger.log(Level.SEVERE, "Error publishing translation save request: " + e.getMessage(), e);
    }
  }

  // Nem beállított környezeti változó miatti hibás telepítés elkerülése.
  // Ha ezt a figyelmeztetést látjuk, a változó beállítása után újra kell telepíteni.
...
public class OcrSaveResult implements BackgroundFunction<PubSubMessage> {
  // TODO: állítsd be ezt a környezeti változót
  ...
  public void accept(PubSubMessage pubSubMessage, Context context) {
    ...
    // Fájl mentése a RESULT_BUCKET tárolóvödörbe newFileName néven
...
Ezek csupán rövid bepillantások voltak abba, amit a jövő tartogathat. Annyi bizonyos, hogy ez a jövő fényes és izgalmas távlatokat nyit. Szóval ne maradj le, figyeld a trendeket, és válj te is a jövő részévé! 
